...
/** 法术灵根属性（九种，与功法一致） */
export const SPELL_ATTRS = TECHNIQUE_ATTRS
export type SpellAttr = TechniqueAttr
...
export const SPELL_CATALOG: CatalogSpell[] = [
  ...
  spell('spell-8', '黄阶', '灵盾术', '无属性', '凝聚灵力护盾抵挡伤害', '防御'),
  spell('spell-9', '黄阶', '疾风步', '风', '短时间提升自身速度', '增益'),
  spell('spell-10', '黄阶', '灵目术', '无属性', '看破部分隐藏目标与幻术', '辅助'),
  spell('spell-51', '黄阶', '炼丹术', '无属性', '掌握丹火与药材配伍，可于丹阁炼制丹药', '生活'),
  spell('spell-52', '黄阶', '炼器术', '无属性', '掌握炉火与矿材淬炼，可于器阁打造法宝', '生活'),
  // 玄阶
  ...
  spell('spell-17', '玄阶', '烈焰风暴', '火', '火焰与狂风融合形成持续风暴', '群体'),
  spell('spell-18', '玄阶', '雷火爆', '雷', '将雷火之力融合后产生剧烈爆炸', '爆发'),
  spell('spell-19', '玄阶', '五行剑气', '无属性', '五种属性剑气同时攻击敌人', '群体'),
  ...
  spell('spell-26', '地阶', '万剑归宗', '金', '化出万道剑气攻击敌人', '群体'),
  spell('spell-27', '地阶', '雷狱', '雷', '形成雷霆牢笼困住敌人', '控制'),
  spell('spell-28', '地阶', '九幽魂刺', '冰', '凝聚神魂之刺直接攻击敌人神魂', '神魂'),
  spell('spell-29', '地阶', '五行逆转', '无属性', '改变战场五行力量并削弱敌人', '辅助'),
  spell('spell-30', '地阶', '天罡护体', '金', '凝聚天罡之气，大幅降低受到的伤害', '防御'),
  // 天阶
  spell('spell-31', '天阶', '太虚剑气', '金', '剑气撕裂空间，对目标造成巨大伤害', '单体'),
  spell('spell-32', '天阶', '九天神雷', '雷', '引动九天神雷进行毁灭性打击', '群体'),
  spell('spell-33', '天阶', '凤凰涅槃', '火', '受到致命伤害时浴火重生', '复活'),
  spell('spell-34', '天阶', '万魂噬天', '冰', '召唤万千魂力吞噬敌人神魂', '群体'),
  spell('spell-35', '天阶', '星陨术', '无属性', '召唤巨大星辰从天而降', '群体'),
  spell('spell-36', '天阶', '虚空大手印', '风', '跨越空间直接镇压目标', '单体'),
  spell('spell-37', '天阶', '天剑降世', '金', '召唤天剑从天而降，造成毁灭打击', '爆发'),
  spell('spell-38', '天阶', '九幽冥火', '火', '冥火同时灼烧肉身与神魂', '持续'),
  spell('spell-39', '天阶', '万雷天牢', '雷', '形成覆盖战场的雷霆牢笼', '控制'),
  spell('spell-40', '天阶', '乾坤挪移', '风', '瞬间移动自身或交换目标位置', '位移'),
  // 仙阶
  spell('spell-41', '仙阶', '九天仙雷', '雷', '召唤仙界雷霆，对目标造成毁灭伤害', '群体'),
  spell('spell-42', '仙阶', '太阴仙光', '冰', '释放太阴仙光持续削弱敌人', '持续'),
  spell('spell-43', '仙阶', '太阳真火', '火', '召唤太阳真火焚烧万物', '群体'),
  spell('spell-44', '仙阶', '仙剑斩天', '金', '一剑斩破天地，对目标造成巨额伤害', '单体'),
  spell('spell-45', '仙阶', '万界传送', '风', '跨越世界进行远距离传送', '位移'),
  spell('spell-46', '仙阶', '时间回溯', '无属性', '将自身状态短暂回溯至数息之前', '特殊'),
  spell('spell-47', '仙阶', '六道仙轮', '无属性', '召唤六道轮回之力攻击敌人', '群体'),
  spell('spell-48', '仙阶', '鸿蒙神雷', '雷', '引动鸿蒙雷霆毁灭目标及其法则', '群体'),
  spell('spell-49', '仙阶', '混沌仙火', '火', '混沌仙火焚烧肉身、神魂与法则', '持续'),
  spell('spell-50', '仙阶', '万道归墟', '无属性', '融合万千法则，将目标归于虚无', '终极')
]
