...
const src = 'd:/project/text-based-cultivation/src/assets/beasts/atlas.png'
...
function findBands(scores, minGap = 3, minWidth = 20) {
...
const cols = findBands(colScore, 3, 18)
...
fs.writeFileSync(
  'd:/project/text-based-cultivation/src/assets/beasts/_proj.json',
